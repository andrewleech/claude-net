...
Source paths are `/home/corona/...`; carbon paths are `/home/corona/...`. Three
...
2. the **`claude -c` history dir** (encoded cwd `-home-anl-picolet` →
   `-home-corona-picolet`),
3. **hardcoded `/home/corona`** in test harnesses / debug repros / package script
...
```
rsync -a /home/corona/picolet/        corona@carbon:/home/corona/picolet/
rsync -a /home/corona/claude-net/     corona@carbon:/home/corona/claude-net/       # worktree link target — required
rsync -a /home/corona/claude-net-mpy/ corona@carbon:/home/corona/claude-net-mpy/   # the mpy-plugin worktree
...
The rsync'd `.git` files still point at `/home/corona/...`. `git worktree repair`
...
## 3. On carbon: rewrite hardcoded /home/corona -> /home/corona
...
git grep -l /home/corona | xargs sed -i 's,/home/corona,/home/corona,g'
git commit -asm "adapt hardcoded paths for carbon (/home/corona -> /home/corona)"
# picolet repo has few/none in code, but check:
cd /home/corona/picolet && git grep -l /home/corona
```
...
entries embed the old `cwd:/home/corona/picolet` as historical metadata — that's
